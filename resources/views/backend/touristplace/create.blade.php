...
@section('title', 'Add Tourist Place')
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Add Tourist Place</h4>

            </div>
            <div class="card-body">
                <div class="basic-form">
                    <form action="{{ route('admin.touristplace.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
