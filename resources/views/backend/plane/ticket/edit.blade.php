		...
		<div class="card">
			...
			<div class="card-body">
				<div class="basic-form">
					<form action="{{ route('admin.plane-ticket.update', $ticket->id) }}" method="post">
						@csrf
						@method('PUT')
						...
						<div class="form-group">
							...
							<select class="form-control single-select" id="airplane_id" name="airplane_id">
								...
								<option value="{{ $airline->id }}" {{ $ticket->airplane_id == $airline->id ? 'selected' : '' }}>{{ $airline->name }}</option>
								@endforeach
							</select>
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" min="0" name="business_price" id="business_price" value="{{ $ticket->business_price }}">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" min="0" name="economic_price" id="economic_price" value="{{ $ticket->economic_price }}">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" min="0" name="air_time" id="air_time" value="{{ $ticket->air_time }}">
						...
						<div class="form-group">
							...
							<select class="form-control multiple-select" id="counter" name="counter[]" multiple>
								...
								<option value="{{ $counter->id }}" {{ $ticket->get_counter($counter->id) ? 'selected' : '' }}>{{ $counter->name }}</option>
								@endforeach
							</select>
