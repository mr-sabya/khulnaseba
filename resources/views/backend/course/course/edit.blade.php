				...
				<div class="basic-form">
					<form action="{{ route('admin.course.update', $course->id) }}" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="lecture" id="lecture" value="{{ $course->lecture }}">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="projects" id="projects" value="{{ $course->projects }}">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="short_desc" id="short_desc" rows="10" cols="50">{{ $course->short_desc }}</textarea>
						...
						<div class="form-group form-check">
							<input type="checkbox" class="form-check-input" name="is_free" id="is_free" value="1" {{ $course->is_free == 1 ? 'checked' : '' }}>
