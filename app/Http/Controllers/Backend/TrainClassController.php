...
class TrainClassController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            return datatables()->of(TrainClass::latest()->get())
        ...
        return view('backend.train.trainclass.index');
    }
    ...
    {
        return view('backend.train.trainclass.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        TrainClass::create($input);

        return redirect()->route('admin.trainclass.index')->with('success', 'New Train Class has been added successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.train.trainclass.edit', compact('trainclass'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.trainclass.index')->with('success', 'Train Class has been updated successfully');
    }
